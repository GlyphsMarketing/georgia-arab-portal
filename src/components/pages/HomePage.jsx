              ...
              <motion.div variants={fadeInUp}>
                <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-xl font-bold">{t.ourMission}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 text-center">{t.missionText}</p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-xl font-bold">{t.ourVision}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 text-center">{t.visionText}</p>
                  </CardContent>
                </Card>
              </motion.div>
              ...
              <motion.div variants={fadeInUp}>
                <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-shadow duration-300">
                  <CardHeader className="text-center pb-4">
                    ...
                    <CardTitle className="text-xl font-bold">{t.ourValues}</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-3">
                      <div className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                        <span className="text-gray-700">{t.communityFirst}</span>
                      </div>
                      <div className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                        <span className="text-gray-700">{t.authenticity}</span>
                      </div>
                      <div className="flex items-center">
                        <CheckCircle className="h-5 w-5 text-green-500 mr-2" />
                        <span className="text-gray-700">{t.excellence}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <motion.div variants={fadeInUp}>
                <Link to="/businesses">
                  <Card className="group cursor-pointer border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    <CardHeader className="text-center pb-4">
                    ...
                    <CardContent>
                      <p className="text-gray-600 text-center mb-4">{t.businessDesc}</p>
              ...
              <motion.div variants={fadeInUp}>
                <Link to="/marketplace">
                  <Card className="group cursor-pointer border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <CardContent>
                      <p className="text-gray-600 text-center mb-4">{t.marketplaceDesc}</p>
              ...
              <motion.div variants={fadeInUp}>
                <Link to="/real-estate">
                  <Card className="group cursor-pointer border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <CardContent>
                      <p className="text-gray-600 text-center mb-4">{t.realEstateDesc}</p>
              ...
              <motion.div variants={fadeInUp}>
                <Link to="/jobs">
                  <Card className="group cursor-pointer border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2">
                    ...
                    <CardContent>
                      <p className="text-gray-600 text-center mb-4">{t.jobsDesc}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="grid lg:grid-cols-3 gap-8">
              <motion.div variants={fadeInUp}>
                <Link to="/marketplace">
                  <Card className="group cursor-pointer h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-green-50 to-green-100">
              ...
              <motion.div variants={fadeInUp}>
                <Link to="/jobs">
                  <Card className="group cursor-pointer h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-orange-50 to-orange-100">
                    <CardContent className="p-8 text-center">
                      <div className="w-24 h-24 bg-gradient-to-br from-orange-500 to-orange-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                      ...
                      <div className="flex items-center justify-center text-orange-600 group-hover:text-orange-700 font-medium">
              ...
              <motion.div variants={fadeInUp}>
                <Link to="/real-estate">
                  <Card className="group cursor-pointer h-full border-0 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 bg-gradient-to-br from-purple-50 to-purple-100">
                    <CardContent className="p-8 text-center">
              ...
              {states.map((state, index) => (
                ...
                >
                  <Card className={`border-0 shadow-lg hover:shadow-xl transition-all duration-300 ${
                    state.active ? 'bg-gradient-to-br from-blue-50 to-blue-100 border-blue-200' : ''
                  }`}>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <h3 className={`text-xl font-bold mb-2 ${
                            state.active ? 'text-blue-900' : 'text-gray-900'
                        ...
                        <div className={`w-12 h-12 rounded-full flex items-center justify-center ${
                          state.active ? 'bg-blue-500' : 'bg-gray-200'
